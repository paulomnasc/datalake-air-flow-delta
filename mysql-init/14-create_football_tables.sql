...
CREATE TABLE IF NOT EXISTS `fixtures_trends` (
    ...
    `futbol24_tip` TEXT DEFAULT NULL,
    `futbol24_analysis` TEXT DEFAULT NULL,
    `futbol24_url` VARCHAR(255) DEFAULT NULL,
    `home_rank` INT DEFAULT NULL,
    `away_rank` INT DEFAULT NULL,
    `home_ppg` DECIMAL(4,2) DEFAULT NULL,
    `away_ppg` DECIMAL(4,2) DEFAULT NULL,
    `home_zone` VARCHAR(255) DEFAULT NULL,
    `away_zone` VARCHAR(255) DEFAULT NULL,
    `standings_motivation_score` DECIMAL(4,2) DEFAULT 0.00,
    `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,

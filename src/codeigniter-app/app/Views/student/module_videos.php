...
<div id="content">
    <div class="videos-container">
        <div class="module-header-banner">
            ...
            <a href="<?php echo site_url('curso/' . $course['id']); ?>" style="display: inline-block; margin-bottom: 18px; color: #fff; background: #4f46e5; padding: 8px 18px; border-radius: 6px; font-weight: bold; text-decoration: none;">← Voltar para <?php echo esc($course['name']); ?></a>

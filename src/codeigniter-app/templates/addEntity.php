...
<div id="main-content">
    ...
    <div id="content">
        ...
        <div class="container">
            <h1>Criar Novo <%entity%></h1>
            <form method="post" id="meuFormulario" action="<?php echo route_to('<%entity%>.insert'); ?>">
                <div class="form-group">
                    <label for="descricao">descricao:</label>
                    <input type="text" name="<%entity_field%>" placeholder="<%entity.field%>" required>
                </div>

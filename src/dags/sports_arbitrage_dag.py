...
# DAG desativada a pedido do usuário: busca de Surebets e consumo de API de arbitragem descontinuados
_schedule_interval = None

with DAG(
    'sports_arbitrage_dag',
    default_args=default_args,
    description='[DESATIVADA] Scraping e Cálculo de Arbitragem (Surebets) para o Brasileirão Série A/B',

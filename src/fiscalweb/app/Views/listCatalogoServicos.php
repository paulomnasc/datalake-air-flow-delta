...
<div id="content">        
    <div class="container">
        ...
        <table class="data-table" id="data-table">
            ...
            <td>
                <select name="id_item_contrato" id="id_item_contrato-<?php echo $item->id ?>">
                    <option value="">Selecione...</option>
                    <?php if(isset($id_item_contrato_list)): foreach($id_item_contrato_list as $opt): ?>
                        <option value="<?php echo $opt->id; ?>" <?php if($opt->id == $item->id_item_contrato) echo 'selected'; ?>>
                    ...
                    <td> 
                        <div class="sidebyside-container">
                            ...
                            <form id="deleteForm-<?php echo $item->id; ?>">
                                <button class="delete-button" type="button" onclick="confirmDelete('<?php echo $item->id; ?>', '<?php echo site_url('deleteCatalogoServicos/' . $item->id); ?>', 'deleteForm-<?php echo $item->id; ?>')">🗑️</button>
                            </form>
                        </div>
                    </td>
                </tr>

...
<div id="content">        
    <div class="container">
        <h4 style="text-align: center;">Listagem de StatusRecebimento</h4>
        
        <input type="text" id="filtro-descricao" placeholder="Filtrar">
        <img src="../assets/img/lupa.jpg" >
        
        <form action="<?php echo site_url('addStatusRecebimento'); ?>" method="post">
                ...
                <tr id="row-<?php echo $item->id ?>">
                    ...
                    <td> 
                        <div class="sidebyside-container">
                            <form action="<?php echo site_url('updStatusRecebimento'); ?>" method="post">
                                <input type="hidden" name="id" value="<?php echo $item->id ?>">
                                <button class="edit-button" type="submit">✏️</button>
                            </form>
                            <form id="deleteForm-<?php echo $item->id; ?>">
                                <button class="delete-button" type="button" onclick="confirmDelete('<?php echo $item->id; ?>', '<?php echo site_url('deleteStatusRecebimento/' . $item->id); ?>', 'deleteForm-<?php echo $item->id; ?>')">🗑️</button>
                            </form>
                        </div>
                    </td>
                </tr>

    ...
    <div class="container-menor">
        ...
        <form id="updForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nota_ins1_pontualidade" name="nota_ins1_pontualidade" value="<?php echo $record->nota_ins1_pontualidade; ?>" required>
            </div>

            <div class="form-group">
                <label for="nota_ins2_qualidade">NotaIns2Qualidade:</label>
                <input type="text" id="nota_ins2_qualidade" name="nota_ins2_qualidade" value="<?php echo $record->nota_ins2_qualidade; ?>" required>
            </div>

            <div class="form-group">
                <label for="percentual_glosa">PercentualGlosa:</label>
                <input type="text" id="percentual_glosa" name="percentual_glosa" value="<?php echo $record->percentual_glosa; ?>" required>
            </div>

    ...
    <div class="container-menor">
        ...
        <form id="updForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="remuneracao" name="remuneracao" value="<?php echo $record->remuneracao; ?>" required>
            </div>

            <div class="form-group">
                <label for="base_horas_mes">BaseHorasMes:</label>
                <input type="text" id="base_horas_mes" name="base_horas_mes" value="<?php echo $record->base_horas_mes; ?>" required>
            </div>

            <div class="form-group">
                <label for="base_horas_complexidade">BaseHorasComplexidade:</label>
                <input type="text" id="base_horas_complexidade" name="base_horas_complexidade" value="<?php echo $record->base_horas_complexidade; ?>" required>
            </div>

            <div class="form-group">
                <label for="sla_dias">SlaDias:</label>
                <input type="text" id="sla_dias" name="sla_dias" value="<?php echo $record->sla_dias; ?>" required>
            </div>

            <div class="form-group">
                <label for="estim_max_ano">EstimMaxAno:</label>
                <input type="text" id="estim_max_ano" name="estim_max_ano" value="<?php echo $record->estim_max_ano; ?>" required>
            </div>

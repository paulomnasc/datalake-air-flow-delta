...
$routes->match(['get', 'post'], '/subscription/simulate-mp-pix/(:segment)', 'SubscriptionController::simulateMpPixStatus/$1', ['as'=>'subscription.simulateMpPixStatus']); // Simular aprovação Pix MP (Dev)
